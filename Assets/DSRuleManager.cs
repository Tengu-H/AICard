...
public class DSRuleManager : MonoBehaviour
{
    ...
    public void OnSendButtonClicked()
    {
        ...
        GameObject.Find("Maggy").GetComponent<Animator>().SetTrigger("Say");
        // 添加用户消息到对话历史
